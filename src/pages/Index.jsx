            ...
            <Box bg="white" p={6} borderRadius="md" boxShadow="md">
              ...
              <VStack spacing={4} alignItems="flex-start" mt={8}>
                ...
                <VStack spacing={2} alignItems="flex-start">
                  <Text><strong>Start Fare:</strong> £{startFare.toFixed(2)}</Text>
                  <Text><strong>Distance Fare:</strong> £{distanceFare.toFixed(2)}</Text>
                  <Text><strong>Additional Passengers Fare:</strong> £{additionalPassengersFare.toFixed(2)}</Text>
                  <Text><strong>Children Fare:</strong> £{childrenFare.toFixed(2)}</Text>
                  <Text><strong>Luggage Fare:</strong> £{luggageFare.toFixed(2)}</Text>
                  <Text><strong>Cycles Fare:</strong> £{cyclesFare.toFixed(2)}</Text>
                  <Text><strong>Waiting Time Fare:</strong> £{waitingTimeFare.toFixed(2)}</Text>
                </VStack>
              </VStack>
            </Box>
          </GridItem>
